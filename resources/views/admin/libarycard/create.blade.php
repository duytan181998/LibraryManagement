@extends('admin.mater')
@section('namepage',"Thêm thẻ thư viện")
@section('content')
    <div class="col-md-12 col-sm-12 col-xs-12">
        @include('admin.block.alert')
        <div class="x_panel">
            <div class="x_title">
                <h2>Thêm Mới Thẻ Thư Viện </h2>
            ...
            <div class="x_content">
                <br />
                <form  action="{!! route('admin.libarycard.postadd',['id'=>$reader['id']]) !!}"  class="form-horizontal form-label-left" method="post">
                    {!! csrf_field() !!}
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Ngày Hết Hạn <span class="required">*</span>
                        </label>

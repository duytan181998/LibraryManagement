@extends('admin.mater')
@section('namepage',"Thêm mới tác giả")
@section('content')
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <br />
                <form  action="{!! route('admin.author.postadd') !!}"  class="form-horizontal form-label-left" method="post">
                    {!! csrf_field() !!}
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Tên Tác Giả <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="tentacgia"  class="form-control col-md-7 col-xs-12">
                            <br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="website"  class="form-control col-md-7 col-xs-12">
                            <br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="note"  class="form-control col-md-7 col-xs-12">
